...
import { useCaisseStore } from "./CaisseStore2";
import PrintInvoice from "./PrintInvoiceCaisse2";
      ...
      <div className="flex  justify-center">
        ...
        <div id="right" className="w-full flex flex-col min-w-[650px] bg-slate-600 select-none">
          ...
          <div className="flex items-center justify-between gap-4 px-2 py-1 bg-white">
            ...
            <hr className="w-10" />
            <div id="option" className="flex items-center border text-lg p-2 border-slate-400">
