    ...
    <div className="grow overflow-y-auto h-[600px]">
      <div className=" p-6 space-y-6 ">
        ...
        <div className="relative flex gap-10 shrink-0">
            ...
            <div className="absolute bg-transparent top-[20px]  left-[80px] shrink-0">
              <label htmlFor="dropzone-file" className="flex flex-col justify-center items-center h-20 p-4 bg-transparent rounded-lg  border-gray-300 border-dashed cursor-pointer  hover:bg-gray-10">
                <div className="flex flex-col justify-center items-center pt-5 pb-4">
                  <img htmlFor="dropzone-file" className="w-[100px] h-[100px]  rounded-full bg-contain" src={store?.get("user")?.logo || logo} width="80" height="80" alt="User upload" />
                </div>
                <input
                  id="dropzone-file"
                  onChange={(e) => {
          ...
          <section className="max-w-[600px] relative overflow-auto">
            <h2 className="text-xl text-slate-800 font-bold mb-5"> Liste Utilisateurs</h2>
            <div className="flex">
              <div className=" ">
                <div className="flex relative flex-wrap overflow-auto gap-5 items-center justify-between p-2">
